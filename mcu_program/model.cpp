...
{    
    ctx.add(new BinaryTensor<uint8_t>({3,3,16,16}, inline_conv_1_Variable_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({16}, inline_conv_1_bias_0), 
            "conv_1/bias:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<uint8_t>({3,3,16,16}, inline_conv_2_Variable_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({16}, inline_conv_2_bias_0), 
            "conv_2/bias:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<uint8_t>({3,3,16,16}, inline_conv_3_Variable_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({16}, inline_conv_3_bias_0), 
            "conv_3/bias:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<float>({1,1,16,32}, inline_conv_4_Variable_0), 
            "conv_4/Variable:0", 
            2);
}
{    
    ctx.add(new BinaryTensor<int>({1}, inline_conv_4_feature_map_eightbit_conv_4_Variable__port__0_reshape_dims_0), 
            "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reshape_dims:0", 
            1);
}
{
    ctx.add(new RamTensor<float>(), "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reshape:0", 2);
    ctx.push(new ReshapeOp(), 
             { "conv_4/Variable:0", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reshape_dims:0" },
             { "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reshape:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<int>({1}, inline_conv_4_feature_map_eightbit_conv_4_Variable__port__0_reduction_dims_0), 
            "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reduction_dims:0", 
            2);
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "conv_4/feature_map_eightbit/conv_4/Variable__port__0/min:0", 1);
    ctx.push(new MinOp(), 
             { "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reshape:0", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reduction_dims:0" },
             { "conv_4/feature_map_eightbit/conv_4/Variable__port__0/min:0" });
    ctx.eval();
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "conv_4/feature_map_eightbit/conv_4/Variable__port__0/max:0", 1);
    ctx.push(new MaxOp(), 
             { "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reshape:0", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/reduction_dims:0" },
             { "conv_4/feature_map_eightbit/conv_4/Variable__port__0/max:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<uint8_t>(), "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:0", 1);
    ctx.add(new RamTensor<float>({1}), "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:1", 1);
    ctx.add(new RamTensor<float>({1}), "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:2", 1);
    ctx.push(new QuantizeV2Op(),
             {  "conv_4/Variable:0",  "conv_4/feature_map_eightbit/conv_4/Variable__port__0/min:0", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/max:0" },
             {  "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:0",  "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:1", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:2" });
    ctx.eval();
}
{
    ...
    ctx.push(new QntConvOp<uint8_t, uint8_t, int>({ 1, 1, 1, 1 }, VALID),
             { "MaxPool_1/eightbit:0", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:0", "MaxPool_1/eightbit:1", "MaxPool_1/eightbit:2", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:1", "conv_4/feature_map_eightbit/conv_4/Variable__port__0/quantize:2" },
...
{    
    ctx.add(new BinaryTensor<float>({32}, inline_conv_4_bias_0), 
            "conv_4/bias:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<uint8_t>({1,1,32,64}, inline_conv_5_Variable_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({64}, inline_conv_5_bias_0), 
            "conv_5/bias:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<uint8_t>({64,64}, inline_fully_connect_weight_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({64}, inline_fully_connect_bias_0), 
...
{    
    ctx.add(new BinaryTensor<uint8_t>({64,32}, inline_fully_connect_1_weight_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({32}, inline_fully_connect_1_bias_0), 
...
{    
    ctx.add(new BinaryTensor<float>({32,10}, inline_fully_connect_2_weight_0), 
...
{
    ctx.add(new RamTensor<float>(), "fully_connect_2/logits:0", 1);
...
{    
    ctx.add(new BinaryTensor<int>({1}, inline_pred_dimension_0), 
            "pred/dimension:0", 
            1);
}
{
    ctx.add(new RamTensor<int>(), "pred:0");
    ctx.push(new ArgMaxOp<float, int>(), 
             { "fully_connect_2/logits:0", "pred/dimension:0" },
             { "pred:0" });
}
}