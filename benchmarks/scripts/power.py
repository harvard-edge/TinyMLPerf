...
def power():
        ...
        parsed_results = segment(parsed_results)[-1]
        plot_results(parsed_results)
        avg_cur, avg_power = get_averages_from_parsed_data(parsed_results)
        print ('Average Current (Amps): ' + str(avg_cur))
        print ('Average Power (Watts): ' + str(avg_power))
        res = {
                "avg_cur" : avg_cur,
                "avg_power" : avg_power,
                "raw_power_results" : parsed_results
                }
