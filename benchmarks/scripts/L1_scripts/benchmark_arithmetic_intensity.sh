...
python3 benchmarks/src/generate.py --tier L1 --task ArithmeticIntensityTask --output-path ${generate_dir} --nfloats "[128, 65536]" --arith_intens "[.25, .5, 1, 2, 4, 8, 16, 32, 64]"

for i in 128 65536; do
   for j in 0.25 0.5 1 2 4 8 16 32 64; do
        # Compile and run
