...
{    
    ctx.add(new BinaryTensor<int>({1}, inline_activations_1_eightbit_Variable_1__port__0_reshape_dims_0), 
            "activations_1_eightbit/Variable_1__port__0/reshape_dims:0", 
            1);
}
{
    ctx.add(new RamTensor<float>(), "activations_1_eightbit/Variable_1__port__0/reshape:0", 2);
    ctx.push(new ReshapeOp(), 
             { "Variable_1:0", "activations_1_eightbit/Variable_1__port__0/reshape_dims:0" },
             { "activations_1_eightbit/Variable_1__port__0/reshape:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<int>({1}, inline_activations_1_eightbit_Variable_1__port__0_reduction_dims_0), 
            "activations_1_eightbit/Variable_1__port__0/reduction_dims:0", 
            2);
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "activations_1_eightbit/Variable_1__port__0/min:0", 1);
    ctx.push(new MinOp(), 
             { "activations_1_eightbit/Variable_1__port__0/reshape:0", "activations_1_eightbit/Variable_1__port__0/reduction_dims:0" },
             { "activations_1_eightbit/Variable_1__port__0/min:0" });
    ctx.eval();
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "activations_1_eightbit/Variable_1__port__0/max:0", 1);
    ctx.push(new MaxOp(), 
             { "activations_1_eightbit/Variable_1__port__0/reshape:0", "activations_1_eightbit/Variable_1__port__0/reduction_dims:0" },
             { "activations_1_eightbit/Variable_1__port__0/max:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<uint8_t>(), "activations_1_eightbit/Variable_1__port__0/quantize:0", 1);
    ctx.add(new RamTensor<float>({1}), "activations_1_eightbit/Variable_1__port__0/quantize:1", 1);
    ctx.add(new RamTensor<float>({1}), "activations_1_eightbit/Variable_1__port__0/quantize:2", 1);
    ctx.push(new QuantizeV2Op(),
             {  "Variable_1:0",  "activations_1_eightbit/Variable_1__port__0/min:0", "activations_1_eightbit/Variable_1__port__0/max:0" },
             {  "activations_1_eightbit/Variable_1__port__0/quantize:0",  "activations_1_eightbit/Variable_1__port__0/quantize:1", "activations_1_eightbit/Variable_1__port__0/quantize:2" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<int>(), "activations_1/eightbit:0", 2);
    ctx.add(new RamTensor<float>({1}), "activations_1/eightbit:1", 2);
    ctx.add(new RamTensor<float>({1}), "activations_1/eightbit:2", 2);
    ctx.push(new QuantizedAddOp<uint8_t, uint8_t, int>(), 
             { "MatMul/eightbit/requantize:0", "MatMul/eightbit/requantize:1", "MatMul/eightbit/requantize:2", "activations_1_eightbit/Variable_1__port__0/quantize:0", "activations_1_eightbit/Variable_1__port__0/quantize:1",  "activations_1_eightbit/Variable_1__port__0/quantize:2" },
             { "activations_1/eightbit:0", "activations_1/eightbit:1",  "activations_1/eightbit:2" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<float>({1}), "activations_1/eightbit/requant_range:0", 1);
    ctx.add(new RamTensor<float>({1}), "activations_1/eightbit/requant_range:1", 1);
    ctx.push(new Requantization_RangeOp(),
             { "activations_1/eightbit:0", "activations_1/eightbit:1", "activations_1/eightbit:2" },
             { "activations_1/eightbit/requant_range:0", "activations_1/eightbit/requant_range:1" });
    ctx.eval();
}
{   
    ctx.add(new RamTensor<uint8_t>(), "activations_1/eightbit/requantize:0", 1);
    ctx.add(new RamTensor<float>({1}), "activations_1/eightbit/requantize:1", 1);
    ctx.add(new RamTensor<float>({1}), "activations_1/eightbit/requantize:2", 1);
    ctx.push(new RequantizeOp(),
             { "activations_1/eightbit:0", "activations_1/eightbit:1", "activations_1/eightbit:2", "activations_1/eightbit/requant_range:0", "activations_1/eightbit/requant_range:1" },
             { "activations_1/eightbit/requantize:0", "activations_1/eightbit/requantize:1", "activations_1/eightbit/requantize:2" });
    ctx.eval();
}
{
...
{    
    ctx.add(new BinaryTensor<uint8_t>({32,64}, inline_Variable_2_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<int>({1}, inline_activations_2_eightbit_Variable_3__port__0_reshape_dims_0), 
            "activations_2_eightbit/Variable_3__port__0/reshape_dims:0", 
            1);
}
{
    ctx.add(new RamTensor<float>(), "activations_2_eightbit/Variable_3__port__0/reshape:0", 2);
    ctx.push(new ReshapeOp(), 
             { "Variable_3:0", "activations_2_eightbit/Variable_3__port__0/reshape_dims:0" },
             { "activations_2_eightbit/Variable_3__port__0/reshape:0" });
    ctx.eval();
}
{    
    ctx.add(new BinaryTensor<int>({1}, inline_activations_2_eightbit_Variable_3__port__0_reduction_dims_0), 
            "activations_2_eightbit/Variable_3__port__0/reduction_dims:0", 
            2);
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "activations_2_eightbit/Variable_3__port__0/min:0", 1);
    ctx.push(new MinOp(), 
             { "activations_2_eightbit/Variable_3__port__0/reshape:0", "activations_2_eightbit/Variable_3__port__0/reduction_dims:0" },
             { "activations_2_eightbit/Variable_3__port__0/min:0" });
    ctx.eval();
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "activations_2_eightbit/Variable_3__port__0/max:0", 1);
    ctx.push(new MaxOp(), 
             { "activations_2_eightbit/Variable_3__port__0/reshape:0", "activations_2_eightbit/Variable_3__port__0/reduction_dims:0" },
             { "activations_2_eightbit/Variable_3__port__0/max:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<uint8_t>(), "activations_2_eightbit/Variable_3__port__0/quantize:0", 1);
    ctx.add(new RamTensor<float>({1}), "activations_2_eightbit/Variable_3__port__0/quantize:1", 1);
    ctx.add(new RamTensor<float>({1}), "activations_2_eightbit/Variable_3__port__0/quantize:2", 1);
    ctx.push(new QuantizeV2Op(),
             {  "Variable_3:0",  "activations_2_eightbit/Variable_3__port__0/min:0", "activations_2_eightbit/Variable_3__port__0/max:0" },
             {  "activations_2_eightbit/Variable_3__port__0/quantize:0",  "activations_2_eightbit/Variable_3__port__0/quantize:1", "activations_2_eightbit/Variable_3__port__0/quantize:2" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<int>(), "activations_2/eightbit:0", 2);
    ctx.add(new RamTensor<float>({1}), "activations_2/eightbit:1", 2);
    ctx.add(new RamTensor<float>({1}), "activations_2/eightbit:2", 2);
    ctx.push(new QuantizedAddOp<uint8_t, uint8_t, int>(), 
             { "MatMul_1/eightbit/requantize:0", "MatMul_1/eightbit/requantize:1", "MatMul_1/eightbit/requantize:2", "activations_2_eightbit/Variable_3__port__0/quantize:0", "activations_2_eightbit/Variable_3__port__0/quantize:1",  "activations_2_eightbit/Variable_3__port__0/quantize:2" },
             { "activations_2/eightbit:0", "activations_2/eightbit:1",  "activations_2/eightbit:2" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<float>({1}), "activations_2/eightbit/requant_range:0", 1);
    ctx.add(new RamTensor<float>({1}), "activations_2/eightbit/requant_range:1", 1);
    ctx.push(new Requantization_RangeOp(),
             { "activations_2/eightbit:0", "activations_2/eightbit:1", "activations_2/eightbit:2" },
             { "activations_2/eightbit/requant_range:0", "activations_2/eightbit/requant_range:1" });
    ctx.eval();
}
{   
    ctx.add(new RamTensor<uint8_t>(), "activations_2/eightbit/requantize:0", 1);
    ctx.add(new RamTensor<float>({1}), "activations_2/eightbit/requantize:1", 1);
    ctx.add(new RamTensor<float>({1}), "activations_2/eightbit/requantize:2", 1);
    ctx.push(new RequantizeOp(),
             { "activations_2/eightbit:0", "activations_2/eightbit:1", "activations_2/eightbit:2", "activations_2/eightbit/requant_range:0", "activations_2/eightbit/requant_range:1" },
             { "activations_2/eightbit/requantize:0", "activations_2/eightbit/requantize:1", "activations_2/eightbit/requantize:2" });
    ctx.eval();
}
{
