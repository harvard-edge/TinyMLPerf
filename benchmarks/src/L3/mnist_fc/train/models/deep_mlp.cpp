...
{    
    ctx.add(new BinaryTensor<uint8_t>({128,128}, inline_Variable_2_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({128}, inline_Variable_3_0), 
            "Variable_3:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<uint8_t>({128,10}, inline_Variable_4_quantized_const_0), 
